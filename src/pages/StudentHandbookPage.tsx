...
} from "@/locales/studentHandbookPageDefaults";

function trHandbook(t: TFunction, key: keyof typeof STUDENT_HANDBOOK_PAGE_DEFAULTS) {
  return t(key, { defaultValue: STUDENT_HANDBOOK_PAGE_DEFAULTS[key] });
}
...
export default function StudentHandbookPage() {
  ...
  const leafTitle = trHandbook(t, "studentHandbookPageTitle");
            ...
            <div className="order-1 lg:order-none lg:col-span-9">
              <div className="mt-0 max-w-none">
                ...
                <p className="mt-3 text-body-article text-muted-foreground">
                  {trHandbook(t, "studentHandbookPageIntro")}
                </p>
                <StudentAcademicPdfDownloadCards cards={STUDENT_HANDBOOK_DOWNLOAD_CARDS} />
              </div>
            </div>
