...
import { ACADEMIC_POSITIONS_PAGE_DEFAULTS } from "@/locales/academicPositionsDefaults";

function trAcademicPositions(
  t: TFunction,
  key: keyof typeof ACADEMIC_POSITIONS_PAGE_DEFAULTS,
) {
  return t(key, { defaultValue: ACADEMIC_POSITIONS_PAGE_DEFAULTS[key] });
}
...
export default function AcademicPositionsPage() {
  ...
  const pageTitle = trAcademicPositions(t, "academicPositionsPageTitle");
      ...
      <main className="below-header">
        ...
        <div className="container mx-auto flex min-h-[60vh] max-w-[1348px] items-center px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
          <article className="mx-auto flex max-w-xl flex-col items-center text-center">
            <img
              src={trAcademicPositions(t, "academicPositionsEmptyImageSrc")}
              alt={trAcademicPositions(t, "academicPositionsEmptyImageAlt")}
            ...
            <p className="mt-3 text-body-article text-muted-foreground">
              {trAcademicPositions(t, "academicPositionsEmptyMessage")}
            </p>
          </article>
        </div>
      </main>
