...
const PROFILE = {
  pageTitle: "Dean of the Faculty of Medicine",
  roleShort: "DEAN OF THE FACULTY OF MEDICINE",
  name: "Babamuratov Bekzod Ergashevich",
  degree: "Doctor of philosophy in technical sciences, associate professor",
  phone: "+99890-749-09-09",
  email: "babamuratov1985@mail.ru",
  telegram: "+99890-749-09-09",
  reception: "Haftaning ish kunlari soat 15-00 dan 17-00 gach",
  imageSrc: "/images/university/dean-medicine.png",
} as const;
...
export default function DeanMedicinePage() {
