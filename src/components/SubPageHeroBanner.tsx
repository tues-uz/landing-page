...
export function SubPageHeroBanner({ staticImageSrc }: SubPageHeroBannerProps = {}) {
  ...
  const shellClassName =
    "relative h-[min(45vh,520px)] min-h-[240px] w-full overflow-hidden sm:min-h-[300px] md:min-h-[380px] lg:min-h-[420px]";
