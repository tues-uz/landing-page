...
import { StudentAcademicPdfDownloadCards } from "@/components/StudentAcademicPdfDownloadCards";
import {
  STUDENT_UNION_REGULATION_DOWNLOAD_CARDS,
  STUDENT_UNION_REGULATION_PAGE_DEFAULTS,
} from "@/locales/studentUnionRegulationPageDefaults";

function trUnion(t: TFunction, key: keyof typeof STUDENT_UNION_REGULATION_PAGE_DEFAULTS) {
  return t(key, { defaultValue: STUDENT_UNION_REGULATION_PAGE_DEFAULTS[key] });
}

const HUB_PATH = "/student-life/student-academic-support";

export default function StudentUnionRegulationPage() {
  ...
  const leafTitle = trUnion(t, "studentUnionRegulationPageTitle");
            ...
            <div className="order-1 lg:order-none lg:col-span-9">
              <div className="mt-0 max-w-none">
                ...
                <p className="mt-3 text-body-article text-muted-foreground">
                  {trUnion(t, "studentUnionRegulationPageIntro")}
                </p>
                <StudentAcademicPdfDownloadCards cards={STUDENT_UNION_REGULATION_DOWNLOAD_CARDS} />
              </div>
            </div>
