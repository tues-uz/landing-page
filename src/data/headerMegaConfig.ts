...
export const universityMegaLinks: MegaLinkDef[] = [
  ...
  { href: "#requisites", icon: FileSearch, labelKey: "header.university.requisites" },
  ...
  { href: "#graduates", icon: GraduationCap, labelKey: "header.university.graduates" },
  { href: "#faculties", icon: School, labelKey: "header.university.faculties" },
  { href: "#departments", icon: Building2, labelKey: "header.university.departments" },
