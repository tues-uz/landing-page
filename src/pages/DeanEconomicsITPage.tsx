...
const PROFILE = {
  pageTitle: "Dean of the Faculty of Economics and Information Technology",
  roleShort: "DEAN OF THE FACULTY OF ECONOMICS AND INFORMATION TECHNOLOGY",
  name: "Yarmatov Sharofiddin Choriyevich",
  phone: "+99891-576-77-67",
  email: "sharofiddinyarmatov76@mail.ru",
  telegram: "+99891-576-77-67",
  reception: "Haftaning barcha ish kunlari 14:00-16:00",
  imageSrc: "/images/university/dean-economics-it.png",
} as const;
...
export default function DeanEconomicsITPage() {
